"""
Phase 5 - create the Texas candidate-angle campaign (Aug 2026) and push leads.

CLONE of push_texas_demand.py for the Aug 2026 campaign on sheet
"Healthcare Texas Indeed Leads - Aug 2026" (tab: Leads). The July push script
feeds the July campaign and is NOT touched.
...
- LARGE 500+ rows are INCLUDED (Jude, 2026-08-27) — this campaign doubles as
  the large-org-CEO test the July data confounded. Read replies BY SIZE BAND.

Usage:
  python3 -W ignore push_texas_candidate.py --sheet_url "URL" --dry_run
  python3 -W ignore push_texas_candidate.py --sheet_url "URL"
  python3 -W ignore push_texas_candidate.py --sheet_url "URL" --campaign_id ID
"""
...
STEP3 = ("<div>Hi {{firstName}},<br /><br />"
         "My name is Rood. I connect Texas healthcare employers with "
         "recruiters that can actually deliver.<br /><br />"
         "Recently a clinic here in Texas had an NP role sitting for 45 days. "
...
def main():
    ...
    ap.add_argument("--campaign_name",
                    default="Healthcare Texas Candidate - Aug 2026")
