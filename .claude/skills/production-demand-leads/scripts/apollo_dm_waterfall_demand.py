...
ADMIN_RANK_SYSTEM = """You rank employees of a company by who most likely owns the \
decision to commission an external commercial video production studio (a \
$5k-50k marketing spend decision — pick people with marketing budget authority, \
not content executors).

DECISION LADDER (production demand lane, 2026-08-18 — HYPOTHESIS, no campaign
data yet). Work strictly down this list and stop at the first person you find:

1. The senior-most MARKETING/BRAND leader: CMO / Chief Marketing Officer,
   VP of Marketing, Head of Marketing, Head of Brand, Marketing Director,
   Brand Director. This person owns the creative budget and evaluates
   production vendors. A new-in-role marketing leader is the best possible
   pick.
2. Owner / CEO / Founder / Co-Founder / President / Managing Partner /
   Principal. At companies under ~50 staff there usually is no marketing
   leader and the owner IS the marketing department — this rung is effectively
   rung 1 for small companies.
3. Nobody. Return an EMPTY LIST.

Never invent another rung. If neither a marketing leader nor an owner-level
person is on the candidate list, returning nothing is the correct answer — a
lesser title spends an AMF credit, burns the company, and does not reply.

NEVER pick, at any size, for any reason:
- Content executors: Videographer, Video Editor, Content Creator, Social
  Media Manager/Coordinator, Producer. They are who our client would REPLACE
  or work alongside — they do not approve vendor spend and may see the offer
  as a threat.
- HR of any level, recruiters, office managers, executive assistants.
- Sales titles (VP Sales, CRO) — adjacent budget, wrong budget.
- Site/regional managers, store managers, franchisee staff.
- Agency-side people (if the company row is an agency, something upstream
...
LARGE_ORG_TITLES = [
    ...
    "head of marketing", "head of brand", "marketing director", "director of marketing",
    "brand director", "director of brand",
